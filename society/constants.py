...
EXPERIMENT_MODE_INHERITANCE_ON = "inheritance_on"
EXPERIMENT_MODE_INHERITANCE_OFF = "inheritance_off"
EXPERIMENT_MODE_MEMORIALS_ONLY = "memorials_only"
EXPERIMENT_MODE_TABOO_REGISTRY_ONLY = "taboo_registry_only"
EXPERIMENT_MODE_ISOLATED_BASELINE = "isolated_baseline"
...
BUNDLE_ARCHIVE_ADMISSION_PUBLIC_SCORE_FLOOR = 0.84
BUNDLE_ARCHIVE_ADMISSION_USEFUL_STREAK = 2
BUNDLE_ARCHIVE_POST_ADMISSION_GRACE_GENERATIONS = 1
BUNDLE_ARCHIVE_COMPARATIVE_LIFT_MIN = 0.01
BUNDLE_ARCHIVE_COMPARATIVE_LIFT_STREAK = 2
BUNDLE_ARCHIVE_UNDERPERFORM_PUBLIC_SCORE_MARGIN = 0.015
BUNDLE_ARCHIVE_UNDERPERFORM_EVICTION_STREAK = 1
BUNDLE_ARCHIVE_REENTRY_BACKOFF_GENERATIONS = 2
BUNDLE_ARCHIVE_COEXISTENCE_BUDGET_GENERATIONS = 2
BUNDLE_ARCHIVE_COEXISTENCE_REQUIRED_LANES = 3
BUNDLE_ARCHIVE_REPEAT_EVICTION_PROVING_STREAK_BONUS = 1
BUNDLE_ARCHIVE_REPEAT_EVICTION_BACKOFF_ESCALATION = 2
BUNDLE_ARCHIVE_REPEAT_EVICTION_RETIREMENT_THRESHOLD = 2
BUNDLE_ARCHIVE_COOLDOWN_DEBT_THRESHOLD = 1
BUNDLE_ARCHIVE_DECAY_PRUNE_GENERATION_THRESHOLD = 2
BUNDLE_ARCHIVE_DECAY_PRUNE_SLOTS = 1
