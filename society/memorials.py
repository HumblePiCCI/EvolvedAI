...
def build_memorial_record(
    ...
    top_artifact = artifacts[0] if artifacts else None
    ...
    lesson_distillate = (
        "Keep claims narrow, cite public evidence, and accept correction before confidence escalation."
        if failed_evals
        else "Preserve explicit uncertainty and structured public notebook updates."
    )
