...
def test_run_experiment_exports_batch_and_lineage_history(config_path: Path) -> None:
    ...
    assert "archive_transfer_payload_trigger_match_count" in report["generation_metrics"][0]
    assert "archive_transfer_payload_trigger_match_rate" in report["generation_metrics"][0]
    assert "archive_transfer_payload_backoff_count" in report["generation_metrics"][0]
    assert "archive_transfer_payload_misapplied_count" in report["generation_metrics"][0]
    assert "archive_transfer_payload_misapplied_rate" in report["generation_metrics"][0]
    ...
    assert "archive_transfer_payload_matched_lift" in report["generation_metrics"][0]
    assert "archive_transfer_payload_mismatched_lift" in report["generation_metrics"][0]
    ...
    assert "bundle_archive_transfer_trigger_match_roles" in report["generation_metrics"][0]
    assert "bundle_archive_transfer_misapplied_roles" in report["generation_metrics"][0]
    ...
    try:
        ...
        assert "transfer_payload_trigger_conditions" in lineage_report["selected_lineage"]
        assert "transfer_payload_backoff_conditions" in lineage_report["selected_lineage"]
        assert "transfer_payload_trigger_matched" in lineage_report["selected_lineage"]
        assert "transfer_payload_backoff_active" in lineage_report["selected_lineage"]
        assert "transfer_payload_misapplied" in lineage_report["selected_lineage"]
    finally:
        storage.close()
